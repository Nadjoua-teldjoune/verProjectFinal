/* Generated By:JavaCC: Do not edit this line. TacticParserTokenManager.java */
import java.util.*;
import java.io.*;

/** Token Manager. */
public class TacticParserTokenManager implements TacticParserConstants
{
...
/** Constructor. */
public TacticParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public TacticParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
